 ...
 * 使用方法：
 * - 通过CDN引用：
 *    <script src="https://cdn.jsdelivr.net/gh/zacharylabs/nezha-ui@main/vps-value-calculator-dispersion.js"></script>
 * 
 * 全局API：
    ...
    if (typeof MutationObserver !== 'undefined') {
        ...
        new MutationObserver(() => debouncedProcess())
            .observe(targetContainer, {
                childList: true,
                subtree: serverList ? false : true
            });

        console.log(`[VPS Calculator Dispersion] ✓ 已加载 | 监听容器: ${targetContainer.className || 'body'}`);
    }
